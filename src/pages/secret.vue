...
<div class="flex flex-col min-h-[900px] w-full mt-6 rounded-lg justify-between border-4 border-red-600">
    <ul class="p-5 space-y-5">
        <li v-for="n in 5" class="text-blue-600 text-4xl">
    ...
    <div>
        <input class="w-full min-h-[100px] p-5 rounded-xl focus:outline-none focus:bg-pink-300" type="text" placeholder="Type a message here"/>
    </div>
</div>
</template>
